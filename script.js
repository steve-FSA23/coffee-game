...
function updateCoffeeView(coffeeQty) {
    // Setting the innerText of that element to be the coffeeQty passed into this function
    coffeeCounter.innerText = coffeeQty;
}

function clickCoffee(data) {
    // Increment the data object's coffee property by one
    data.coffee++;
    // Calling the updateCoffeeView function and pass it the newly updated data.coffee property
    updateCoffeeView(data.coffee);
    // Calling the renderProducers function and pass it the data object
...
function unlockProducers(producers, coffeeCount) {
    // looping through the producers array passed into the function
...
function getUnlockedProducers(data) {
    // filtering through the data.producers property, and return an array with only the producers whose
